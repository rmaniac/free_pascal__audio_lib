...
uses {$IFDEF FPC} LCLIntf, LResources,
     {$ELSE} Windows, TeeProcs, TeEngine, Series, {$ENDIF}
     SysUtils, Classes, Controls, Forms, StdCtrls, ComCtrls, DAVDCommon,
     DDspFilter,  Spin, Buttons, DASIOHost, ExtCtrls, TAGraph, TASeries, Types, Graphics;
...
type
  ...
  TFmAnalyser = class(TForm)
    ...
    Lb_dB: TLabel;
    procedure BarSeriesBeforeDrawBar(ASender: TBarSeries; ACanvas: TCanvas;
...
procedure TFmAnalyser.BarSeriesBeforeDrawBar(ASender: TBarSeries;
